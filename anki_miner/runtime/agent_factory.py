...
def load_agent_config(path: Path) -> tuple[Path, AgentProfileConfig, AnkiMinerConfig]:
    ...
    removed = {
        ...
        "review_pool_size": "the prepare_mining_run request",
        "max_cards": "the prepare_mining_run request",
        "max_payload_bytes": "Anki Miner internal transport",
        "max_variants": "Anki Miner internal safeguards",
        "max_rationale_chars": "Anki Miner internal safeguards",
        "max_definition_options": "Anki Miner internal safeguards",
        "max_definition_option_chars": "Anki Miner internal safeguards",
        "max_chosen_definition_chars": "Anki Miner internal safeguards",
        "max_sentence_translation_chars": "Anki Miner internal safeguards",
